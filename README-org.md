This repo was originally created with the commands:

- `npm install -g yo generator-code`
- `yo code`
- for _What type of extension do you want to create?_ pick **New Notebook Renderer**

The content following was the original `README.md`.
...
### Running this Sample
 ...
 1. `code-insiders nbort`: Open the folder in VS Code Insiders
